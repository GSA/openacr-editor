...
<ChapterHelpText chapterId="about" />

<ExpandCollapseAll />

<details open>
  <summary>
    <HeaderWithAnchor id="select-catalog" level="2" showAnchor={false}
      >Select report type and catalog</HeaderWithAnchor
    >
  </summary>
  ...
  <button
    class="button"
    on:click={confirmCatalogChange}
    disabled={$evaluation["catalog"] === selectedCatalog}
    style="text-align: center; line-height: 1; padding: 10px;"
    >Switch Catalogs</button
  >
  <button
    class="button"
    on:click={resetCatalogChange}
    disabled={$evaluation["catalog"] === selectedCatalog}
    style="text-align: center; line-height: 1; padding: 10px;">Reset</button
  >
</details>

<details open>
  <summary>
    <HeaderWithAnchor id="product" level="2" showAnchor={false}
      >Product</HeaderWithAnchor
    >
  </summary>
...
<details open>
  <summary>
    <HeaderWithAnchor id="author" level="2" showAnchor={false}
      >Author</HeaderWithAnchor
    >
  </summary>
...
<details open>
  <summary>
    <HeaderWithAnchor id="vendor" level="2" showAnchor={false}
      >Vendor</HeaderWithAnchor
    >
  </summary>
...
<details open>
  <summary>
    <HeaderWithAnchor id="acr-report-details" level="2" showAnchor={false}
      >ACR Report Details</HeaderWithAnchor
    >
  </summary>

  <div class="field">
    <label for="evaluation-report-date"> Report Date </label>
    <input
      type="text"
  ...
  <div class="field">
    <label for="evaluation-last-modified-date"> Last Modified Date </label>
    <input
      type="text"
      readonly
  ...
  <div class="field">
    <label for="evaluation-version"> Version </label>
  ...
  <div class="field">
    <label for="evaluation-evaluation-methods-used"
      >Evaluation Methods Used</label
    >
    <textarea
  ...
  <div class="field">
    ...
    <Select
      ...
      inputStyles="border: 1px solid var(--grey);"
      items={spdxLicenses}
      value={$evaluation["license"]}
      on:select={handleLicenseSelect}
      on:clear={handleLicenseClear}
    >
...
<details open>
  <summary>
    <HeaderWithAnchor id="related-openacrs" level="2" showAnchor={false}
      >Related OpenACRs</HeaderWithAnchor
    >
  </summary>
  ...
  <AddOther
    label="Add related OpenACR"
    on:ADD={handleRelatedAdd}
...
<details open>
  <summary>
    <HeaderWithAnchor id="disabled-chapters" level="2" showAnchor={false}
      >Disabled Chapters/Tables</HeaderWithAnchor
    >
  </summary>
...
<Pager label="Previous/Next Principle">
  ...
  <PagerLink to="/chapter/success_criteria_level_a" direction="next"
    >A</PagerLink
  >
</Pager>
